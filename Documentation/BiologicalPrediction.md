...
| Preserve biology through integration | Complete HIRISA execution and coarse response checks pass. Native annotation retention fails 37/146 supported, sensitive comparisons, including 10/29 rare comparisons. | The rigid projection still fails 31/146; its [label breakdown](../Tools/Omics/Benchmarks/HIRISA/RigidProjection/Diagnosis/README.md) includes 7 B intermediate and 5 CD14 Mono failures. Resolve preservation losses and validate independently; neither candidate is promoted. |
