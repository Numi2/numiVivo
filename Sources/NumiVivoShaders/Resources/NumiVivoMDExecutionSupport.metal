...
kernel void nvivo_md_drift_constraint_impulse(
...
kernel void nvivo_md_projected_force_seed(
...
kernel void nvivo_md_validate_projected_force(
...
kernel void nvivo_md_observation_terms(
...
kernel void nvivo_md_sum_pair_reduce(
