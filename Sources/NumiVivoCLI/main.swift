...
if VivoWorkflowCLICommands.handles(arguments.first) {
    ...
    if arguments.isEmpty || ["help", "--help", "-h"].contains(arguments.first ?? "") {
        ...
        FileHandle.standardOutput.write(Data("\nQM/MM activation free energy and transmission: qmmm-free-energy-analyze, qmmm-transmission-analyze, qmmm-transmission-apply, qmmm-free-energy-rate, qmmm-free-energy-replicated-rate, qmmm-free-energy-help.\n".utf8))
