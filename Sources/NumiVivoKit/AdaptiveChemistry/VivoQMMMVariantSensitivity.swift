...
public enum VivoQMMMVariantSensitivity {
    ...
    public static func calculate(_ request: VivoQMMMVariantSensitivityRequest) throws -> VivoQMMMVariantSensitivityResult {
        ...
        // The huge reconstruction tolerance above exists only so the established
        // invariant checker can validate the comparison without deciding the
        // adaptive campaign's scientific tolerance for it.
