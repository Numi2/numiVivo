...
public struct VivoUnitSystem: Sendable {
    ...
    public init() {
        ...
        let volumeRate = VivoDimension(length: 3, time: -1)
        ...
        let amountRate = VivoDimension(time: -1, amount: 1)
        ...
        add(["m3/s", "m^3/s"], dimension: volumeRate, scale: 1)
        add(["L/s"], dimension: volumeRate, scale: 1e-3)
        add(["mL/s"], dimension: volumeRate, scale: 1e-6)
        add(["uL/s", "µL/s"], dimension: volumeRate, scale: 1e-9)
        add(["L/min"], dimension: volumeRate, scale: 1e-3 / 60)
        add(["mL/min"], dimension: volumeRate, scale: 1e-6 / 60)
        add(["uL/min", "µL/min"], dimension: volumeRate, scale: 1e-9 / 60)
        add(["L/h", "L/hour"], dimension: volumeRate, scale: 1e-3 / 3_600)
        add(["mL/h", "mL/hour"], dimension: volumeRate, scale: 1e-6 / 3_600)
        ...
        add(["mol/s"], dimension: amountRate, scale: 1)
        add(["mmol/s"], dimension: amountRate, scale: 1e-3)
        add(["umol/s", "µmol/s"], dimension: amountRate, scale: 1e-6)
        add(["nmol/s"], dimension: amountRate, scale: 1e-9)
        add(["pmol/s"], dimension: amountRate, scale: 1e-12)
