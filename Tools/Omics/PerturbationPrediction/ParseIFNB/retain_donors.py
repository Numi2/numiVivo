...
def main():
 ...
 sources=[Path(__file__),Path(__file__).parent/'retain.py',repo/'Tools/Omics/PerturbationPrediction/Duration/archive.py',repo/'Tools/Omics/PerturbationPrediction/Duration/common.py']
