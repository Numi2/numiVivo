...
root=Path('/Users/n/numivivo-metal-normalization-20260911');binary=root/'runtime-cli/numivivo-omics';source=Path('/Users/n/numivivo-legacy-count-route-20260911/count-store')
...
for label,flags in [('cli-cpu',[]),('cli-metal',['--backend','metal-fp32']),('cli-cpu-explicit',['--backend','cpu-fp64'])]:
 ...
 base=root/('metal-0' if 'metal' in label else 'cpu-0')
