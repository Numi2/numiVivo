...
source=a.out/'over-sixteen-gib.h5ad'
with source.open('wb') as f: f.truncate(17_179_869_185)
...
if a.scoped: command=[str(a.binary.resolve()),'annotate',str(source),str(plan),str(destination)]
...
assert not destination.exists() and source.stat().st_size==17_179_869_185
# This is a generated sparse invalid-input fixture, never the experimental file.
source.unlink()
(a.out/'report.json').write_text(json.dumps(dict(status='passed',sourceBytes=17_179_869_185,
