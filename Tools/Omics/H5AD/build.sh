...
mkdir -p "$OUT"
FILES=()
for name in VivoStreamedLogCPM VivoPairedMultiomeIO VivoWeightedNeighbors VivoModalityWeights VivoAccessibilityLSI VivoAccessibilityLSIIO VivoAccessibilityTFIDF VivoAccessibilityTFIDFIO VivoSparseCounts VivoBufferedCountRecords VivoOmicsFileSnapshot VivoH5ADCountStore VivoMetalCountNormalization VivoMetalFeatureStatistics VivoMultiAssay VivoH5ADCountAccess VivoMultiAssayH5MUImport VivoMultiAssayTenX VivoMultiAssayVisium VivoMultiAssayH5MU VivoMultiAssayIO VivoQuantitativeAssay VivoQuantitativeAssaySummary VivoQuantitativeAssayAssociation VivoQuantitativeH5MU VivoQuantitativeH5MUIO VivoMatrixMarketCounts VivoOmicsLinearStatistics VivoOmicsNegativeBinomial VivoMetalNegativeBinomialLikelihood VivoCountObservation VivoCountObservationCalibration VivoPairedCountMoments VivoCountRateLikelihood VivoJointCountResponse VivoAdaptiveJointCountResponse VivoOmicsNBCohort VivoOmicsNBSupport VivoOmicsSourceDecoder VivoOmicsDesignObservation VivoExpressionReportJSON VivoFileExpression VivoPseudobulkDifferentialExpression VivoSingleCellAnalysis VivoSingleCellArtifacts VivoSingleCellCampaign VivoSingleCellCampaignIO VivoSingleCellReduction VivoMetalSparsePCAOperators VivoSingleCellPrograms VivoSingleCellReference VivoReferenceLogistic VivoCellTypistReference VivoCellTypistReferenceIO VivoSingleCellReferenceIO VivoPerturbation VivoPerturbationIO VivoDurationPerturbation VivoDurationPerturbationIO VivoComposition VivoCompositionIO VivoTargetKernel VivoTargetKernelIO VivoH5ADReduction VivoH5ADPCA VivoFrozenPCAProjection VivoH5ADPCAQuery VivoWindowedPCANeighbors VivoMetalPCANeighbors VivoHNSWNeighbors VivoPCAGraphStore VivoPCANeighborBundle VivoSingleCellNeighbors VivoClusteringGraph VivoPCAGraphClustering VivoSingleCellClustering VivoEmbeddingSchedule VivoPCAGraphEmbedding VivoSingleCellEmbedding VivoSingleCellIntegration VivoIntegrationMatrix VivoMNNIntegration VivoPCAMNNIntegration VivoPCAIntegration VivoSingleCellCohortAnalysis VivoSingleCellExamples VivoSingleCellExchange VivoSingleCellProcessing VivoHDF5 VivoSingleCellH5AD VivoH5ADPseudobulk VivoCountStreamPseudobulk VivoFileCellAxis VivoFileCountStream VivoH5ADElements VivoH5ADAnnotations VivoH5ADProjectionIO VivoH5ADLegacyIO VivoH5ADProjection VivoOmicsNBDevianceMoments VivoOmicsNBAdaptiveMoments VivoOmicsRobustLowess VivoOmicsNBQLGlobalScale VivoOmicsNBAbundance VivoOmicsQLSpecialFunctions VivoOmicsPrecisionLowess VivoOmicsQLModeration VivoOmicsNBQLInference VivoOmicsNBQLCohort; do
