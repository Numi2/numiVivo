...
oracle=read('control-means-oracle.json')
assert oracle['status']=='passed' and oracle['controlCells']==403449
assert oracle['modelsSHA256']==m['members']['models.json']
assert oracle['scriptSHA256']==m['members']['check_control_means.py']
assert oracle['maximumControlMeanError']<1e-10 and oracle['maximumShiftError']<1e-10
