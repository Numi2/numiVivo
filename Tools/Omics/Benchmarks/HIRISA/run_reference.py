#!/usr/bin/env python3
"""Run all sixteen frozen HIRISA Bioconductor cohorts, retaining warnings and failures."""
...
script=Path(__file__).resolve().parents[2]/'NegativeBinomial/IndependentNull/reference.R';out=root/'reference';out.mkdir(exist_ok=True)
