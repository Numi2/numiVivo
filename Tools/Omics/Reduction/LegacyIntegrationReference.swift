...
struct VivoLegacyIntegrationInput { let cells: [VivoOmicsCellIdentity]; let scores: [[Double]] }

struct VivoLegacyIntegrationResult: Codable, Sendable, Equatable {
    let method: String
...
enum VivoLegacyIntegrationReference {
    ...
    static func run(_ reduction: VivoLegacyIntegrationInput, samples: [VivoOmicsSample], options o: VivoSingleCellIntegrationOptions) throws -> VivoLegacyIntegrationResult {
        try o.validate()
