...
M4 Pro with Swift 6.3.3. Additional endpoint assertions pass in a subsequent
eight-test moderation run. Tests cover robustness, original-value posterior
arithmetic, low-DF exclusion, work failures and native abundance integration.

The native executable SHA256 is
`767ca456d26b35ebca587a18c94c9ff6853ad42d740fd1ec81dad41605f61b85`.
The largest observed process resident size is 29,425,664 bytes; profiles visit
